...
| MREB-POST-03 | corpo vazio | — | 400 | `field: body` |
| MREB-POST-04 | campo extra no corpo (`.strict()`) | — | 400 | `errorType: validationError` |
...
| MREB-POST-12 | sem token | — | 401 | `errorType: unauthorized` |
| MREB-POST-13 | admin (não dono) cria manejo em rebanho de A | token admin | 404 | `field: Rebanho`; sem bypass |
| MREB-POST-14 | B tenta criar manejo com `rebanhoId` de A | — | 404 | `field: Rebanho` |
| MREB-POST-15 | `rebanhoId` inexistente | — | 404 | `field: Rebanho` |
| MREB-POST-16 | rebanho inativo | rebanho de A com `ativo:false` | 400 | `field: rebanhoId`, mensagem "rebanho inativo" |
| MREB-POST-17 | `tipoManejoId` inexistente ou inativo | — | 404 | `field: tipoManejoId` |
| MREB-POST-18 | item com `insumoId` inexistente/de outra propriedade | — | 400 | `field: itens` |
| MREB-POST-19 | item com insumo de `destino: "Pasto"` (incompatível com rebanho) | — | 400 | `field: itens`, mensagem "não é destinado ao rebanho" |
...
| MREB-GET-12 | query com campo extra | — | 400 | `errorType: validationError` |
| MREB-GET-13 | sem token | — | 401 | `errorType: unauthorized` |
...
| MREB-GET-ID-03 | id inexistente | — | 404 | `field: Manejo de Rebanho` |
| MREB-GET-ID-04 | sem token | — | 401 | `errorType: unauthorized` |
...
| MREB-PATCH-ID-02 | corpo vazio | — | 400 | `field: body` |
| MREB-PATCH-ID-03 | campo extra (`.strict()`) | — | 400 | `errorType: validationError` |
...
| MREB-PATCH-ID-06 | id inexistente | — | 404 | `field: Manejo de Rebanho` |
| MREB-PATCH-ID-07 | `tipoManejoId` inexistente ou inativo | — | 404 | `field: tipoManejoId` |
...
| MREB-PATCH-ID-09 | sem token | — | 401 | `errorType: unauthorized` |
| MREB-PATCH-ID-10 | multi-tenancy: B tenta atualizar manejo de A | — | 404 | `field: Manejo de Rebanho` |
...
| MREB-DELETE-ID-04 | id inexistente | — | 404 | `field: Manejo de Rebanho` |
| MREB-DELETE-ID-05 | sem token | — | 401 | `errorType: unauthorized` |
| MREB-DELETE-ID-06 | multi-tenancy: B tenta remover manejo de A | — | 404 | `field: Manejo de Rebanho` |

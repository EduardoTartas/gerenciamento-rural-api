...
| UPL-POST-03 | nenhum arquivo enviado | A autenticado; requisição multipart sem campo `file` (ou sem corpo multipart) | 400 | `errorType` `validationError`; `field` `file`; mensagem "Nenhum arquivo enviado."; storage não é chamado |

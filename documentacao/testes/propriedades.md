...
| PROP-GET-07 | `limit` acima de 100 é truncado para 100 | A tem mais de 100 propriedades | 200 | `data.limit` = 100, mesmo pedindo `?limit=500` (`PropriedadeService.list`, `Math.min(...,100)`) |
